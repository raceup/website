...
(function( $ ) {
    ...
    $.fn.productConfigurator = function(options) {
		...
		return this.each(function() {
			...
			var configuratorDiv = $("<div></div>").addClass("configurator" + themeClass), 
				...
				credits = $("<div></div>").addClass("credits").html("Developed by Race UP Company &copy; 2022"),
	...
	$.fn.productConfigurator.updateTotalPrice = function (){
		...
		$(".summary .price div:last-child, .buy .inner .info .price div:last-child").html(price.toPrecision(6) + $.fn.productConfigurator.internal.currency);
